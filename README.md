...
![Forge](https://img.shields.io/badge/Forge-61.1.0-red.svg)
...
当前 `1.21.11` 分支是面向 **Minecraft Forge 1.21.11** 的客户端自动化 Mod / 脚本框架系统，围绕 **路径动作 + 触发器 + 序列编排 + 变量系统 + 数据包能力 + 可视化 GUI** 构建。
