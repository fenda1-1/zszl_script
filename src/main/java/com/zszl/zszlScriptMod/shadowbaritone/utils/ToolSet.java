...
public class ToolSet {
    ...
    private int getMaterialCost(ItemStack itemStack) {
        return ItemComponentCompat.getMaterialCost(itemStack);
    }
    ...
    public int getBestSlot(Block b, boolean preferSilkTouch, boolean pathingCalculation) {
        ...
        */
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (!Baritone.settings().useSwordToMine.value && ItemComponentCompat.isSword(itemStack)) {
                continue;
            }
    ...
    public static double calculateSpeedVsBlock(ItemStack item, BlockState state) {
        ...
        if (speed > 1) {
            int effLevel = getItemEnchantmentLevel(Enchantments.EFFICIENCY, item);
    ...
    private static int getItemEnchantmentLevel(ResourceKey<Enchantment> enchantment, ItemStack stack) {
