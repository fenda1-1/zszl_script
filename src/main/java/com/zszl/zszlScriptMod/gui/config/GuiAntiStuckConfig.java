    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 0) { // 总开关
            ...
            try {
                ...
                if (mc.player != null) {
                    mc.player.displayClientMessage(new TextComponentString(I18n.format("msg.antistuck.saved")), false);
                }
                mc.setScreen(parentScreen);
            } catch (NumberFormatException e) {
                if (mc.player != null) {
                    mc.player.displayClientMessage(new TextComponentString(I18n.format("msg.common.invalid_number")), false);
                }
            }
