...
public class KeybindManager {
    ...
    public static void executeAction(BindableAction action) {
        ...
        switch (action) {
            case STOP_SEQUENCE:
                ...
                mc.player
                        .displayClientMessage(new TextComponentString(ChatFormatting.RED + I18n.format("msg.keybind.stop_all")), false);
                break;
            case SET_LOOP_COUNT:
            ...
            case TOGGLE_MOUSE_DETACH:
                ...
                mc.player.displayClientMessage(
                        new TextComponentString(
                                ChatFormatting.AQUA + I18n.format("msg.keybind.mouse_status", mouseStatus)), false);
            ...
            case OPEN_INVENTORY_VIEWER:
                ...
                mc.player.displayClientMessage(
                        new TextComponentString(ChatFormatting.AQUA + I18n.format("msg.keybind.open_inventory_viewer")), false);
                break;
            case TOGGLE_AUTO_EAT:
                AutoEatHandler.autoEatEnabled = !AutoEatHandler.autoEatEnabled;
                AutoEatHandler.saveAutoEatConfig();
                mc.player.displayClientMessage(new TextComponentString(I18n.format("msg.keybind.common_toggle_status",
                        I18n.format("keybind.action.toggle_auto_eat.name"),
                        AutoEatHandler.autoEatEnabled ? I18n.format("gui.common.enabled")
                                : I18n.format("gui.common.disabled"))), false);
                break;
                ...
                if (keybind != null && keybind.getParameter() != null && !keybind.getParameter().isEmpty()) {
                    ...
                    if (seq != null) {
                        ...
                        mc.player.displayClientMessage(new TextComponentString(
                                ChatFormatting.RED
                                        + I18n.format("msg.keybind.packet_sequence_not_found", sequenceName)), false);
                    }
                } else {
                    mc.player.displayClientMessage(new TextComponentString(
                            ChatFormatting.YELLOW + I18n.format("msg.keybind.packet_sequence_not_bound")), false);
                }
                break;
        }
    }
    ...
    public static void executePathSequenceByName(String sequenceName) {
        ...
        if (!PathSequenceManager.hasSequence(sequenceName)) {
            mc.player.displayClientMessage(new TextComponentString(ChatFormatting.RED
                    + I18n.format("msg.keybind.path_sequence_not_found", sequenceName)), false);
            return;
        }
    ...
    private static void toggleManagedFeature(Minecraft mc, BindableAction action) {
        ...
        mc.player.displayClientMessage(new TextComponentString(I18n.format("msg.keybind.common_toggle_status",
                ...
                targetEnabled ? I18n.format("gui.common.enabled") : I18n.format("gui.common.disabled"))), false);
    }
    ...
    private static void sendMissingManagedFeatureMessage(Minecraft mc, String featureId) {
        ...
        mc.player.displayClientMessage(new TextComponentString(
                ChatFormatting.RED + "[快捷键] 未找到其他功能: " + featureId), false);
    }
