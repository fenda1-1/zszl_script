            ...
            case TOGGLE_AUTO_EQUIP:
                ...
                mc.player.displayClientMessage(
                        new TextComponentString(
                                ChatFormatting.AQUA + I18n.format("msg.debug_keybind.auto_equip_status", status)), false);
                AutoEquipHandler.saveConfig();
                break;
            case START_CHEST_RECORDING:
                mc.player.displayClientMessage(
                        new TextComponentString(
                                ChatFormatting.AQUA + I18n.format("msg.debug_keybind.open_chest_recording")), false);
