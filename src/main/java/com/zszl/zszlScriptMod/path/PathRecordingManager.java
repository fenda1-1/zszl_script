...
public class PathRecordingManager {
    ...
    private static EventListener registeredListener;
    ...
    public static void startRecording() {
        ...
        isRecording = true;
        recordedSteps.clear();
        registeredListener = PlayerInteractEvent.RightClickBlock.BUS.addListener(eventListener::onPlayerRightClickBlock);
    ...
    private static void unregisterListener() {
        if (registeredListener != null) {
            PlayerInteractEvent.RightClickBlock.BUS.removeListener(registeredListener);
